...
import 'package:hello/screens/ticket_view.dart';
import 'package:hello/utils/app_info_list.dart';
import 'package:hello/utils/app_layout.dart';
import 'package:hello/utils/app_styles.dart';
import 'package:hello/widgets/column_layout.dart';
import 'package:hello/widgets/layout_builder_widget.dart';
import 'package:hello/widgets/ticket_tabs.dart';
                       ...
                       children: [
                         Row(
                           children: [
                             ...
                             Text(" *** 2554", style: Styles.headLineStyle3,)
                           ],
                         ),
                         Gap(5),
              ...
              child: Container(
                ...
                child: ClipRRect(
                  ...
                  child: BarcodeWidget(barcode: Barcode.code128(),
                    data: 'hhtps://github.com/martinovovo',
                      drawText: false,
